...
const environments = {
    dev: {
        ...
        NEXT_PUBLIC_GRAPHQL_URL:
            'https://dev.api.explorer.penumbra.pklabs.me/graphql',
        NO_INDEX: true,
    },
    prod: {
        BASE_URL: 'https://explorer.penumbra.zone',
        NEXT_PUBLIC_FATHOM_ID: 'YHKFXWRT',
        NEXT_PUBLIC_GRAPHQL_URL: 'https://api.explorer.penumbra.zone/graphql',
    },
    staging: {
        BASE_URL: 'https://explorer.penumbra.pklabs.me',
        NEXT_PUBLIC_GRAPHQL_URL:
            'https://api.explorer.penumbra.pklabs.me/graphql',
        NO_INDEX: true,
    },
}
