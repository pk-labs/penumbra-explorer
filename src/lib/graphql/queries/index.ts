...
export { default as validatorVotingPercentageQuery } from './validatorVotingPercentage.graphql'
export { default as validatorVotingPowerQuery } from './validatorVotingPower.graphql'
